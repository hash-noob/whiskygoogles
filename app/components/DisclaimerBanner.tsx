...
const DisclaimerBanner: React.FC<DisclaimerBannerProps> = ({ minimal = false }) => {
  if (minimal) {
    return (
      <p className="text-xs text-amber-600 dark:text-amber-500/70 mt-2 mb-4 lg:text-left text-center">
  ...
  return (
    <div className="bg-amber-100 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 rounded-lg p-3 my-4">
      <div className="flex items-start">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-amber-600 dark:text-amber-500">Accuracy Disclaimer</h3>
          <div className="mt-1 text-xs text-amber-700 dark:text-amber-400/80">
            <p>
