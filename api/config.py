...
class Settings:
    def __init__(self):
        ...
        self.credentials_path = os.getenv('GOOGLE_APPLICATION_CREDENTIALS') or os.path.join(os.getcwd(), 'google-credentials.json')
    ...
    def get_credentials(self):
        ...
        credential_source = None  # Initialize credential_source at the start
        try:
